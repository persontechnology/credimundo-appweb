...
@section('content')
    ...
    <form action="{{ route('tipo-transacciones.store') }}" method="POST" autocomplete="off">
        @csrf
        <div class="card">
                ...
                <div class="col-md-6 mb-1">
                    <div class="form-floating form-control-feedback form-control-feedback-start">
                        ...
                        <select class="form-select @error('tipo') is-invalid @enderror" name="tipo" required>
                            <option value=""></option>
                            <option value="SUMAR" {{ old('tipo')=='SUMAR'?'selected':'' }}>SUMAR</option>
                            <option value="RESTAR" {{ old('tipo')=='RESTAR'?'selected':'' }}>RESTAR</option>
                        </select>
