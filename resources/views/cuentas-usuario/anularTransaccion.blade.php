...
<form action="{{ route('cuentas-usuario.anularTransaccionGuardar') }}" method="POST" autocomplete="off" id="formCreateTransaccion">
    ...
    <div class="card">
        ...
        <div class="card-body row">
            ...
            <p id="contenido">
                <strong>Cuenta:</strong> {{ $trans->cuentaUser->tipoCuenta->codigo }}, {{ $trans->cuentaUser->numero_cuenta }} <br>
                <strong>Socio:</strong> {{ $trans->cuentaUser->user->apellidos_nombres }} <br>
                <strong>Cédula/Ruc:</strong> {{ $trans->cuentaUser->user->identificacion }} <br>
