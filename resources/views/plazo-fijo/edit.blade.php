@extends('layouts.app')
@section('breadcrumbs')
{{ Breadcrumbs::render('plazo-fijo.edit',$plazoFijo) }}
@endsection
@section('content')

<form action="{{ route('plazo-fijo.update',$plazoFijo) }}" method="POST" autocomplete="off" id="formCredito">
    @csrf
    @method('PUT')
    <div class="card">
				...
				<div class="thirty form row">
                    ...
                    <div class="col-md-4 mb-1">
                        <div class="form-floating form-control-feedback form-control-feedback-start">
                            ...
                            <input name="monto" id="monto" value="{{ old('monto',$plazoFijo->monto) }}" step="0.01" min="0" type="number" class="accrue-amount form-control @error('monto') is-invalid @enderror" required autofocus>
                    ...
                    <div class="col-md-4 mb-1">
                        <div class="form-floating form-control-feedback form-control-feedback-start">
                            ...
                            <input name="plazo" id="plazo" value="{{ old('plazo',$plazoFijo->plazo) }}" type="plazo" class="accrue-term form-control @error('plazo') is-invalid @enderror" required>
                    ...
                    <div class="col-md-4 mb-1">
                        <div class="form-floating form-control-feedback form-control-feedback-start">
                            ...
                            <select class="accrue-rate form-select @error('tipo_credito') is-invalid @enderror" name="tipo_credito" id="tipo_credito" required>
                                ...
                                <option value="{{ $tt->tasa_efectiva_anual }}" {{ old('tipo_credito',$plazoFijo->tipoCredito->tasa_efectiva_anual)==$tt->tasa_efectiva_anual?'selected':'' }}>{{ $tt->tasa_efectiva_anual }}% {{ $tt->nombre }}</option>    
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-8 mb-1">
                        <div class="form-floating form-control-feedback form-control-feedback-start">
                            ...
                            <input type="hidden" name="cuenta_user" id="cuenta_user" value="{{ old('cuenta_user',$plazoFijo->cuenta_user_id) }}" required>
                            <input name="apellidos_nombres" id="txt_apellidos_nombres" value="{{ old('apellidos_nombres',$plazoFijo->cuentaUser->user->apellidos_nombres) }}" type="text" class="form-control @error('apellidos_nombres') is-invalid @enderror" data-bs-toggle="modal" data-bs-target="#modal_full" required >
                            <input type="hidden" id="numero_cuenta" name="numero_cuenta" value="{{ old('numero_cuenta',$plazoFijo->cuentaUser->numero_cuenta) }}">
                            <label id="numeroCuenta" >N° cuenta:{{ old("numero_cuenta",$plazoFijo->cuentaUser->numero_cuenta) }}<i class="text-danger">*</i></label>
                    ...
                    <div class="col-md-4 mb-1">
                        <div class="form-floating form-control-feedback form-control-feedback-start">
                            ...
                            <input name="numero_credito" value="{{ old('numero_credito',$plazoFijo->credito_id) }}" type="text" class="form-control @error('numero_credito') is-invalid @enderror">
                    ...
                    <div class="col-md-4 mb-1">
                        <div class="form-floating form-control-feedback form-control-feedback-start">
                            ...
                            <input name="dia_pago" id="dia_pago" value="{{ old('dia_pago',$plazoFijo->dia_pago) }}" type="date" class="form-control @error('dia_pago') is-invalid @enderror" required>
                    ...
                    <div class="col-md-4 mb-1">
                        <div class="form-floating form-control-feedback form-control-feedback-start">
                            ...
                            <select class="accrue-rate_compare form-select @error('tipo_pago') is-invalid @enderror" name="tipo_pago" id="tipo_pago" required>
                                <option value="Unico" {{ old('tipo_pago',$plazoFijo->tipo_pago)=='Unico'?'selected':'' }}>Unico</option>
                                <option value="Mensual" {{ old('tipo_pago',$plazoFijo->tipo_pago)=='Mensual'?'selected':'' }}>Mensual</option>
                    ...
                    <div class="col-md-4 mb-1">
                        <div class="form-floating form-control-feedback form-control-feedback-start">
                            ...
                            <input name="detalle" value="{{ old('detalle',$plazoFijo->detalle) }}" type="text" class="form-control @error('detalle') is-invalid @enderror">
                            <label>Detalle</label>
                            @error('detalle')
                                <div class="invalid-feedback">
                                    {{ $message }}
