...
class PlazoFijoDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($c){
            return view('plazo-fijo.action',['c'=>$c])->render();
        })
     ...
     */
    public function query(PlazoFijo $model): QueryBuilder
    {
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('numero')->title('N° C.P.F'),
